...
function mvp_scripts_method() {
	wp_register_script('elastislide', get_template_directory_uri() . '/js/jquery.elastislide.js', 'jquery', '', true);
	wp_register_script('hottopix', get_template_directory_uri() . '/js/scripts.js', 'jquery', '1.6', true);
	wp_register_script('respond', get_template_directory_uri() . '/js/respond.min.js', 'jquery', '', true);
	wp_register_script('retina', get_template_directory_uri() . '/js/retina.js', 'jquery', '', true);
	...
	wp_enqueue_style( 'googlefonts', 'http://fonts.googleapis.com/css?family=Open+Sans:400,600,700|Open+Sans+Condensed:300,700|Oswald:300,400,700|Alegreya:400&subset=latin,latin-ext,cyrillic,cyrillic-ext,greek-ext,greek,vietnamese' );
	}
}
...
@import url(http://fonts.googleapis.com/css?family=$google_menu:100,200,300,400,500,600,700,800,900|$google_feature:100,200,300,400,500,600,700,800,900|$google_headlines:100,200,300,400,500,600,700,800,900&subset=latin,latin-ext,cyrillic,cyrillic-ext,greek-ext,greek,vietnamese);
